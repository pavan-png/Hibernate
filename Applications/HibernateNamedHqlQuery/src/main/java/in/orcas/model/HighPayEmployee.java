...
@Entity
@Table(name = "highpayemp")
@NamedQuery(name = "Named_HQL_Query" ,  query = "INSERT INTO in.orcas.model.HighPayEmployee (eNo,eAddr,eName,eSalary) SELECT eNo,eAddr,eName,eSalary FROM in.orcas.model.Employee WHERE eSalary >= : sal")
public class HighPayEmployee implements Serializable{
